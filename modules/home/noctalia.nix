...
in
{
  ...
  #generate json nix-instantiate --eval -E 'builtins.fromJSON (builtins.readFile ./settings.json)'
  home.file.".config/noctalia/settings.json.template" = {
    text = builtins.toJSON {
      ...
      general = {
        ...
        animationSpeed = 1;
        avatarImage = "/home/dahai003/.face";
        boxRadiusRatio = 1;
      ...
      screenRecorder = {
        ...
        colorRange = "limited";
        directory = "/home/dahai003/Videos";
        frameRate = 60;
        quality = "very_high";
        showCursor = true;
        videoCodec = "h264";
      ...
      wallpaper = {
        directory = "/home/dahai003/Pictures/Wallpapers";
